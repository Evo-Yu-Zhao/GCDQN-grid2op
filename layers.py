...
class GraphConvolution(layers.Layer):
    ...
    def build(self, input_shape):
        self.weight = self.add_weight(name='weight',shape=[input_shape[0][-1], self.output_dim])
    #     self.weights_ = []
    ...
    def call(self, inputs, training=None, flatten=None):
        ...
        support = dot(support_[0], pre_sup, sparse=True) # (D^-0.5)A(D^0.5)HW
